...
import {AddNewMenuItemVariantFields} from "../../constants/menu-item.constant";

//@ts-ignore
const AddMenuItemVariantComponent = ({changeNavigation}) => {
    const [fields, setFields] = useState(AddNewMenuItemVariantFields);
    ...
    const saveChanges = async () => {
        ...
        const {success, message} = await MenuItemsBackendApiService.createMenuItemVariant({
            ...payload,
        });
        if (success) {
    ...
    const initializeData = async () => {
        ...
        setFields((prevFields: any) => {
            return prevFields.map((prevField: any) => {
                if (prevField.fieldName === 'menuItemId') {
                    return {
                        ...prevField,
                        data: menuItemsData,
                    }
...
export default AddMenuItemVariantComponent;
